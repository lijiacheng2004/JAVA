 ...
 * ClassName: ImageResources
 * Package: practise._04
 * Description:
 *
 * @Author Lee JiaCheng
 * @Create 2024/1/25 13:35
 * @Version 1.0
 */
...
public class ImageResources {
    ...
    public static ImageIcon obsersubm;//声明一个用来存侦查潜艇图片的 图片类型的变量
    public static ImageIcon sea;//声明一个用来存海洋背景图片的 图片类型的变量
...
//        getImageLoadStatus(); 获取图片状态 --- 8 没问题 --- 4 有问题
